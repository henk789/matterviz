...
import trajectory_spectroscopy_worker_url from './trajectory-spectroscopy-worker.js?worker&url'
...
>({
  ...
  create_worker: () => load_worker(trajectory_spectroscopy_worker_url),
